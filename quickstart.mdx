...
<Tabs>
  ...
  <Tab title="Docker">
    ```bash
    docker pull algosecure/verdex:latest
    ```
  </Tab>
</Tabs>
...
<Note>
  If you use **Docker**, prefix all Verdex commands with `docker run --rm algosecure/verdex:latest ...`<br/>
  example: `docker run --rm algosecure/verdex:latest -help`
</Note>
